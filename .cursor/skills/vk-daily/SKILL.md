...
Жёстко: Уфа, запрет слова «метро», ~2000 знаков, синий акцент, новая композиция и ротация поз/гардероба (каталог `vk-daily/refs/poses-wardrobe/`, лицо только с селфи), эмодзи только эмоция, без ссылок, без фейковой обложки.
