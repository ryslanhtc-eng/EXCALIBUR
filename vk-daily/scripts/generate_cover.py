    ...
    *,
    ...
    if no_person:
        ...
        prompt_parts.extend([
            ...
            "Metaphorical still-life props: property registration documents folder, official agreement paperwork, apartment keys on polished surface, guardianship office custody resolution file folder (органы опеки), notary stamp — abstract, metaphorical and clean, NO readable personal names, NO real addresses, NO children faces, NO hex codes, NO dashes.",
            "Optional small discreet byline text allowed in small font: «Руслан Мухтаров», but absolute priority is NO face, NO human figure.",
            "NEGATIVE: people, person, man, woman, child, children, face, hands, portrait, crowd, silhouette, human figure, selfie, metro / subway station in Ufa, Moscow skyline, Red Square, English text, watermark, logo, cartoon, neon cyberpunk, hex color codes, dash symbol, low quality.",
        ])
